...
Run the following code chunk to install and restore the required packages.
You can run the code chunck by clicking the green arrow button at right-below
When prompted in the console, type Y at install.packages(), select **2** when prompted by renv::restore(), and type Y again to proceed.
